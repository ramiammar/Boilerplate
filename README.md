...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 16dec526-b519-48f2-9e3d-93d18ec2951e
```
...
* `Emenu.Productmanagement.DbMigrator`: A console application which applies the migrations and also seeds the initial data. It is useful on development as well as on production environment.
* `Emenu.Productmanagement.Web`: ASP.NET Core MVC / Razor Pages application that is the essential web application of the solution.
